...
public class FlowLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < cCount; i++) {
            ...
            /**
             * Modified By SongChao
             * 测量时需要将左右间距减去，不然计算结果会超出父容器
             */
            measureChild(child, widthMeasureSpec - lp.leftMargin - lp.rightMargin, heightMeasureSpec);
            ...
            if (lineWidth + childWidth > sizeWidth - getPaddingLeft() - getPaddingRight()) {
                ...
                lineWidth = childWidth > sizeWidth ? sizeWidth : childWidth;
                height += lineHeight;
